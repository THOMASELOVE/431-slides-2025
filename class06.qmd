...
format:
  revealjs: 
    ...
    footer: "431 Class 06 | 2025-09-18 | <https://thomaselove.github.io/431-2025/>"
---
...
p1 <- ggplot(class06, aes(sample = a1c_diff)) +
...
p2 <- ggplot(class06, aes(x = a1c_diff)) +
...
Method | Estimate | 90% Uncertainty Interval
:------: | -------: | :------------------------:
OLS/t | 0.33 | (0.20, 0.47)
Bayes | 0.33 | (0.19, 0.47)
...
- This should push us towards a method which doesn't require the assumption of Normality.
  ...
  - 90% uncertainty interval with OLS/t test was (0.20, 0.47) and the bootstrap 90% uncertainty interval was also (0.19, 0.47).
...
Bootstrap with pooled sd | 7.36 (0.01, 14.54)

## LDL by Statin prescription status

We'll start with a comparison boxplot.
