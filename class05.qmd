...
- The `dm464` study
  ...
  - Data on 464 adults with diabetes between the ages of 18 and 75
...
- See Chapters 5-6 of [Dr. Love's course book](https://thomaselove.github.io/431-book/) for more.
...
Ingest the data with `read_xlsx()` from **readxl** package^[Excel file downloaded to the `c05/data` subdirectory of my R project file.].
...
## Missingness? Range checks? Types OK?
...
Bayesian fit: `stan_glm()` | 0.33 (0.19, 0.47)
Bootstrap: `boot.t.test()` | 0.33 (0.19, 0.47)
...
Bayesian fit: `stan_glm()` | 7.18 (-0.44, 14.12)
Welch t (unpooled sd) | 7.17 (0.86, 13.48)
Bootstrap, pooled sd | 7.19 (-0.21, 14.39)
Bootstrap, unpooled sd | 7.17 (0.99, 13.13)

## Thanks and Session Information

You should now be ready to do [Lab 2](https://github.com/THOMASELOVE/431-labs-2025/tree/main/lab2).
