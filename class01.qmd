...
library(tidyverse)
ageguess <- read_csv("c01/data/photo-age-history-2024.csv")
ageguess
```
...
ggplot(ageguess, aes(x = age, y = mean_guess, col = year)) +
  ...
  labs(title = "Age Guessing in Previous Years",
       subtitle = "2014-2024 class guesses, plus 2025 AI",
...
ggplot(temp, aes(x = label, y = mean_guess)) +
  ...
  theme_bw() +
  labs(title = "Boxplot of Guesses by Subject, 2014-24",
...
## Mean Class-Wide Errors (2014-24)

![](c01/images/age-photo-mean-error-2014-2024.png)

## 2024 Results: Labeled Scatterplot

```{r, echo = FALSE}
ggplot(filter(ageguess, year == 2024), aes(x = age, y = error, fill = sex)) +
  ...
  theme(axis.text = element_text(size = 14),
        ...
        legend.text = element_text(size = 12),
        legend.title = element_text(size = 12, face = "bold")) +
  labs(title = "Errors in 2024 Age Guessing, by Subject's Sex",
