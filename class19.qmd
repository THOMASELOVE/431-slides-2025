...
format:
  revealjs: 
    ...
    footer: "431 Class 19 | 2025-11-06 | <https://thomaselove.github.io/431-2025/>"
---
...
- `fit2` has higher $R^2$, adjusted $R^2$, lower RMSE and Sigma, higher (weighted) AIC and AIC corrected
...
- After weighting, larger values indicate better fits.
  - `fit2` looks best by AIC and corrected AIC.
  - `fit1` looks best by BIC.
