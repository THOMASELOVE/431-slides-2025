...
## Turning values like 99 into NA

Suppose 77 = "Refused" and 99 = "No Response" or some other term that we want to think of as "missing".
...
How do we convince R the 77s and 99s are missing values?
...
More on `replace_with_na()` [at this link](https://cran.r-project.org/web/packages/naniar/vignettes/replace-with-na.html).

## From 77 and 99 to NA across all variables
...
Other ways to extend `replace_with_na()` are described [in this vignette](https://cran.r-project.org/web/packages/naniar/vignettes/replace-with-na.html).
...
More on `replace_na()` [at this link](https://tidyr.tidyverse.org/reference/replace_na.html).

# Back to regression modeling
